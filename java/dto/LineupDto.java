...
public class LineupDto {
    ...
    private ArrayList<String> starting_players_ids;
    private ArrayList<String> substitutes_ids;
    ...
    public ArrayList<String> getStarting_players_ids() {
        return starting_players_ids;
    }

    public void setStarting_players_ids(ArrayList<String> starting_players_ids) {
        this.starting_players_ids = starting_players_ids;
    }

    public ArrayList<String> getSubstitutes_ids() {
        return substitutes_ids;
    }

    public void setSubstitutes_ids(ArrayList<String> substitutes_ids) {
