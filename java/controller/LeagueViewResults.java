...
public class LeagueViewResults {
    ...
    public ObservableList<MatchDto> getResults() {
        ObservableList<MatchDto> matchDtos = FXCollections.observableArrayList();
        List<MatchDto> results=matchService.getResultsByLeague(leagueDto.getId_league());
    ...
    public void changeToStatisticsFrame(ActionEvent event) throws IOException{
        FXMLLoader loader=new FXMLLoader();
